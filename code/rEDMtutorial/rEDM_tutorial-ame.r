# rEDM_tutorial-ame.r - Adding notes and extra code to the rEDM_tutorial.r
#  (from the vignette dated 2016-10-22). Andrew Edwards, 17th Nov 2016.
...
summary(simp)
summary(simp[[1]])
summary(simp[[2]])    # error since only one component of list
simp2 = simp[[1]]     # easier to type
simp2$params
dim(simp2$model_output)
